...
def toServer(userInput):
    ...
    if command == "/join":
        ...
        print("/exit                        Disconnects from any connected File Exchange Server")
        print("/get [filename]              Download a file of name [filename] from the File Exchange Server")
        ...
        print("/store [filename]            Upload a file of name [filename] to the File Exchange server - [filename] must exist inside the client's directory")
